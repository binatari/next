...
const Navbar = () => {
  const router = useRouter()
    return (
        <div>
            <nav class="bg-slateWhite border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="#" class="flex relative h-full p-[2.25rem] min-w-[10rem]">
    <Image
               className="relative"
              src='/images/appoga-logo.png'
    ...
    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        <li onClick={()=>router.push('/')}>
          <a href="#" class="block py-2 pr-4 pl-3 text-darkPurple  rounded md:bg-transparent  md:p-0 dark:text-white" aria-current="page">Home</a>
        </li>
        <li onClick={()=>router.push('/company')}>
          <a href="#" class="block py-2 pr-4 pl-3 text-pitchBlack border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">company</a>
        </li>
        <li onClick={()=>router.push('/services')}>
          <a href="#" class="block py-2 pr-4 pl-3 text-pitchBlack border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
        </li>
        <li onClick={()=>router.push('/pricing')}>
          <a href="#" class="block py-2 pr-4 pl-3 text-pitchBlack border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Pricing</a>
        </li>
        <li onClick={()=>router.push('/contact')}>
          <a href="#" class="block py-2 pr-4 pl-3 text-pitchBlack hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
        </li>
      </ul>
    </div>
  </div>
